...
import 'package:aura/hooks/use_copy.dart';
...
class RecommendedActivitiesSection extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final (copy, _) = useCopy();

    final colors = useMemoized<List<Color>>(() {
